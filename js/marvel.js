...
async function getJsonGeral() {
    ...
    for (let personagem of json.results) {
        if ((personagem.name == inputGeral) && (personagem.biography.publisher == "Marvel Comics" || personagem.biography.publisher == "Binary" || personagem.biography.publisher == "Rune King Thor" || personagem.biography.publisher == "Goliath")) {
